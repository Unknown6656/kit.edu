...
\begin{document}
    ...
    \begin{equation*}
        \begin{aligned}
            \hbox{\fontsize{13.3pt}{15pt}\selectfont $ \vee $} \hspace{-1.2pt} \forall p,q \in \mathbb{Q} : pq^{-1} \in \mathbb{Q}
        \end{aligned}
    \end{equation*}
    ...
    \begin{equation*}
        \begin{aligned}
            \{ q \in \mathbb{Q} \ | \ \verb"number cannot be divided by " q \}_{\substack{ < \\ \infty }}
        \end{aligned}
    \end{equation*}
    ...
    \begin{equation*}
        \begin{aligned}
            \hbox{\fontsize{13.3pt}{15pt}\selectfont $ \vee $} \hspace{-1.2pt} \forall k \in M : f(k)
            \quad :\Longleftrightarrow \quad
            \{ k \in M \ | \ \neg f(M) \}_{\substack{ < \\ \infty }} =: T \subsetneq \mathbb{K}
            \quad \wedge \quad
